...
HOST_BOOST_FLAGS = --without-icu \
	...
	iostreams locale math mpi program_options python random regex \
...
# breaks on some weak toolchains and it's new for 1.54+
# breaks with some toolchain combinations and it's new for 1.54+
BOOST_WITHOUT_FLAGS = atomic python
